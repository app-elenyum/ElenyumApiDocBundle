...
namespace Elenyum\ApiDocBundle\Render\Html;
 ...
 * @internal
 */
class GetElenyumAsset extends AbstractExtension
{
    ...
    public function __construct(AssetExtension $assetExtension)
    {
        ...
        $this->cdnUrl = 'https://cdn.jsdelivr.net/gh/elenyum/ElenyumApiDocBundle/Resources/public';
    ...
    {
        return [
            new TwigFunction('elenyumAsset', $this, ['is_safe' => ['html']]),
        ];
    }
    ...
    private function getResource($asset, $mode)
    {
        if (filter_var($asset, FILTER_VALIDATE_URL)) {
            ...
            return [$this->assetExtension->getAssetUrl(sprintf('bundles/elenyumapidoc/%s', $asset)), false];
        }
    }

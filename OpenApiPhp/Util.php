...
namespace Elenyum\ApiDocBundle\OpenApiPhp;
 ...
 * Class Util.
 *
 * This class acts as compatibility layer between ElenyumApiDocBundle and swagger-php.
 *
 ...
 *
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getPath()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getSchema()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getProperty()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getOperation()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getOperationParameter()
 *
 * which in turn get or create the Annotation instances through the following more general methods
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getChild()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getCollectionItem()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::getIndexedCollectionItem()
 *
 * which then searches for an existing Annotation through
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::searchCollectionItem()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::searchIndexedCollectionItem()
 *
 * and if not found the Annotation creates it through
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::createCollectionItem()
 * @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::createContext()
 *
 * The merge method @see \Elenyum\ApiDocBundle\OpenApiPhp\Util::merge() has the main purpose to be able

...
namespace Elenyum\ApiDocBundle\Tests\Model;
...
class ModelRegistryTest extends TestCase
{
    ...
    public function provideNameCollisionsTypes()
    {
        yield [
            ...
            [
                'class' => 'Elenyum\\ApiDocBundle\\Tests\\Model\\ModelRegistryTest',
    ...
    public function testUnsupportedTypeExceptionWithNonExistentClass()
    {
        ...
        $this->expectException('\LogicException');
        $this->expectExceptionMessage(sprintf('Schema of type "\%s" can\'t be generated, no describer supports it. Class "\Elenyum\ApiDocBundle\Tests\Model\DoesNotExist" does not exist, did you forget a use statement, or typed it wrong?', $className));

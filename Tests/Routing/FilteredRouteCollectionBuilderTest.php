...
namespace Elenyum\ApiDocBundle\Tests\Routing;
...
class FilteredRouteCollectionBuilderTest extends TestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation Passing an indexed array with a collection of path patterns as argument 1 for `Elenyum\ApiDocBundle\Routing\FilteredRouteCollectionBuilder::__construct()` is deprecated since 3.2.0, expected structure is an array containing parameterized options.
     */
    ...
    public function getRoutesWithDisabledDefaultRoutes(): array
    {
        return [
            ...
            'matching route with Elenyum Annotation' => [
                'r10',
                new Route('/api/foo', ['_controller' => 'ApiController::fooAction']),
                [new Operation([])],
                ['disable_default_routes' => true],

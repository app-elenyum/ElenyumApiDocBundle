...
namespace Elenyum\ApiDocBundle\Tests\SwaggerPhp;
 ...
 * Class UtilTest.
 *
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getOperation
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getOperationParameter
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getChild
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getCollectionItem
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getIndexedCollectionItem
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::searchCollectionItem
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::searchIndexedCollectionItem
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::createCollectionItem
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::createChild
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::createContext
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::merge
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::mergeFromArray
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::mergeChild
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::mergeCollection
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::mergeTyped
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::mergeProperty
 * @covers \Elenyum\ApiDocBundle\OpenApiPhp\Util::getNestingIndexes
 */
        ...
        return [[
            ...
            'merge' => [
                'tags' => [
                    ...
                    // but the complete ElenyumApiDocBundle test suite is not upset by this fact
                    ['name' => $yes],

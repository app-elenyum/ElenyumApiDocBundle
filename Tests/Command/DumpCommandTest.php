...
namespace Elenyum\ApiDocBundle\Tests\Command;

use Elenyum\ApiDocBundle\Render\Html\AssetsMode;
use Elenyum\ApiDocBundle\Tests\Functional\WebTestCase; // for the creation of the kernel
...
YAML;
    ...
    private function executeDumpCommand(array $options)
    {
        ...
        $command = $application->find('elenyum:apidoc:dump');

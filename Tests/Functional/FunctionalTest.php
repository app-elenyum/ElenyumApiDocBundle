...
class FunctionalTest extends WebTestCase
{
    ...
    public function testDefaultOperationId()
    {
        ...
        $this->assertEquals('get_api_elenyum_apidoc_tests_functional_api_fetcharticle', $operation->operationId);
    }
    ...
    /**
     * Related to https://github.com/elenyum/ElenyumApiDocBundle/issues/1756

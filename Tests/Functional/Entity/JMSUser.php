...
class JMSUser
{
    ...
    /**
     * @Serializer\Type("array<Elenyum\ApiDocBundle\Tests\Functional\Entity\User>")
     * @Serializer\Expose
     */
    private $friends;

    /**
     * @Serializer\Type("array<string, Elenyum\ApiDocBundle\Tests\Functional\Entity\User>")
     * @Serializer\Expose
     */
    ...
    /**
     * @Serializer\Type(Elenyum\ApiDocBundle\Tests\Functional\Entity\CustomDateTime::class)
     * @Serializer\Expose
     */
    private $customDate;
    ...
    /**
     * @Serializer\Type("Elenyum\ApiDocBundle\Tests\Functional\Entity\JMSNote")
     * @Serializer\Inline()
     * @Serializer\Expose
     */
    private $notes;

...
use Elenyum\ApiDocBundle\ElenyumApiDocBundle;
...
use Elenyum\ApiDocBundle\Tests\Functional\Entity\PrivateProtectedExposure;
use Elenyum\ApiDocBundle\Tests\Functional\Entity\SymfonyConstraintsWithValidationGroups;
use Elenyum\ApiDocBundle\Tests\Functional\ModelDescriber\VirtualTypeClassDoesNotExistsHandlerDefinedDescriber;
...
class TestKernel extends Kernel
{
    ...
    protected function configureContainer(ContainerBuilder $c, LoaderInterface $loader)
    {
        ...
        // Filter routes
        $c->loadFromExtension('elenyum_api_doc', [
        ...
        $def->addTag('elenyum_api_doc.model_describer');
        $c->setDefinition('elenyum.test.jms.virtual_type.describer', $def);
    }

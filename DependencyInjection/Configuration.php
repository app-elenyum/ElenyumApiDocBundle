...
final class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('elenyum_api_doc');

        if (method_exists($treeBuilder, 'getRootNode')) {
            $rootNode = $treeBuilder->getRootNode();
        } else {
            // symfony < 4.2 support
            $rootNode = $treeBuilder->root('elenyum_api_doc');
        }
            ...
            ->children()
                ...
                ->arrayNode('areas')
                    ...
                    ->validate()
                        ...
                        ->thenInvalid('You must specify a `default` area under `elenyum_api_doc.areas`.')
                    ->end()
